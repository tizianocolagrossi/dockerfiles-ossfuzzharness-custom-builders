...
docker run -it --rm -v $FUZZ_OUT:/fuzz_out -v $DEDUP_BUILD:/dedup_build -v $ANALYSIS_BUILD:/out -e FUZZ_OUT_REAL_PATH=$FUZZ_OUT -e FUZZING_ENGINE=libafl -t osvaldo/oss-base-analysis analyze $FUZZER
