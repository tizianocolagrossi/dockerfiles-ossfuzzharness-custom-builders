...
## run
docker run -it --rm --init -v <fuzzer-build-dir>:/out -v <fuzzer-out-directory>:/fuzz_out --cpuset-cpus=<cpu-id> -e FUZZING_ENGINE=libafl -e TIMEOUT=<max-time> -t oss-base-runner run_fuzzer <fuzzer-name>